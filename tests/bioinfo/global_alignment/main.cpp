...
bool test_nw_identical() {
    ...
    ok &= toolbox::test_utils::check(is_valid_alignment(s, s, a1, a2),
                                     "NW identical: alignment valid");
    return ok;
}
...
bool test_nw_empty_vs_string() {
    ...
    ok &= toolbox::test_utils::check(is_valid_alignment("", s2, a1, a2),
                                     "NW empty vs string: alignment valid");
    return ok;
}
...
bool test_nw_one_mismatch() {
    ...
    ok &= toolbox::test_utils::check(is_valid_alignment(s1, s2, a1, a2),
                                     "NW one mismatch: alignment valid");
    return ok;
}
...
bool test_nw_completely_different() {
    ...
    ok &= toolbox::test_utils::check(is_valid_alignment(s1, s2, a1, a2),
                                     "NW completely different: alignment valid");
    return ok;
}
...
bool test_diff_identical() {
    ...
    ok &= toolbox::test_utils::check(is_valid_alignment(s, s, a1, a2),
                                     "Diff identical: alignment valid");
    return ok;
}
...
bool test_diff_empty() {
    ...
    ok &= toolbox::test_utils::check(is_valid_alignment("", "ABC", a1, a2),
                                     "Diff empty vs ABC: alignment valid");
    return ok;
}
...
bool test_wavefront_identical() {
    ...
    ok &= toolbox::test_utils::check(is_valid_alignment(s, s, a1, a2),
                                     "Wavefront identical: alignment valid");
    return ok;
}
...
bool test_wavefront_general() {
    ...
    ok &= toolbox::test_utils::check(is_valid_alignment(s1, s2, a1, a2),
                                     "Wavefront general: alignment valid");
    return ok;
}
