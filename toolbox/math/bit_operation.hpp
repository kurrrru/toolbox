 ...
 * @note This function uses the built-in `__builtin_popcount` function to count the number of set
 * bits in the given integer.
 */
 ...
 * @note This function uses the built-in `__builtin_popcountll` function to count the number of set
 * bits in the given long long integer.
 */
 ...
 * @note This function uses the built-in `__builtin_clz` function to count the number of leading
 ...
 * @note This function uses the built-in `__builtin_clzll` function to count the number of leading
 ...
 * @note This function calculates the number of bits required to represent the given integer by
 ...
 * @note This function calculates the number of bits required to represent the given long long
