 ...
 * @note [Attention]: This function is not intended to be used directly.
 */
void sais_character_count(const std::vector<int> &s, std::vector<int> &cnt_l,
 ...
 * @note [Attention]: This function is not intended to be used directly.
 */
void sais_search_lms(const int n, const std::vector<bool> &ls, std::vector<int> &lms_map,
                     std::vector<int> &lms) {
    int m = 0;
    for (int i = 1; i < n; i++) {
        if (!ls[i - 1] && ls[i]) {
...
void sais_induce(const std::vector<int> &s, std::vector<int> &sa, const std::vector<int> &cnt_l,
                 const std::vector<int> &cnt_s, const std::vector<bool> &ls,
...
void sais_resolve(const std::vector<int> &s, std::vector<int> &sa, const std::vector<int> &cnt_l,
                  const std::vector<int> &cnt_s, const std::vector<bool> &ls, std::vector<int> &lms,
