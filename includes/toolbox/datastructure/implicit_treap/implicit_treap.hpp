...
struct monoid_range_add_range_min {
    static long long query_op(long long a, long long b) { return (std::min(a, b)); }
    static long long query_id() { return (2e18); }
    static long long update_op(long long a, long long b) { return (a + b); }
    static long long update_id() { return (0); }
...
struct monoid_range_add_range_max {
    static long long query_op(long long a, long long b) { return (std::max(a, b)); }
    static long long query_id() { return (-2e18); }
    static long long update_op(long long a, long long b) { return (a + b); }
    static long long update_id() { return (0); }
    static long long apply(long long a, long long b, int /*len*/) {
...
struct monoid_range_add_range_sum {
    static long long query_op(long long a, long long b) { return (a + b); }
    static long long query_id() { return (0); }
    static long long update_op(long long a, long long b) { return (a + b); }
    static long long update_id() { return (0); }
    static long long apply(long long a, long long b, int len) {
...
struct monoid_range_update_range_min {
    static long long query_op(long long a, long long b) { return (std::min(a, b)); }
    static long long query_id() { return (2e18); }
    static long long update_op(long long /*a*/, long long b) { return (b); }
    static long long update_id() { return (2e18); }
    static long long apply(long long a, long long b, int /*len*/) {
...
struct implicit_treap {
    ...
    void insert(int pos, S val) { insert(_root, pos, new node(val, _rnd.random())); }
 ...
 private:
    struct xorshift {
        ...
        explicit xorshift(unsigned int _seed) : _state(_seed) {}
        unsigned int random() {
            _state ^= _state << 13;
            _state ^= _state >> 17;
            _state ^= _state << 5;
    ...
    void pushdown(node *t) {
        ...
        if (t->_lazy != operations::update_id()) {
            if (t->_child[0]) {
                ...
                t->_child[0]->_acc =
                    operations::apply(t->_child[0]->_acc, t->_lazy, cnt(t->_child[0]));
            }
            if (t->_child[1]) {
                t->_child[1]->_lazy = operations::update_op(t->_child[1]->_lazy, t->_lazy);
                t->_child[1]->_acc =
                    operations::apply(t->_child[1]->_acc, t->_lazy, cnt(t->_child[1]));
            }
